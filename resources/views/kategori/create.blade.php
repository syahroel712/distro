                                ...
                                <div class="col-md-12">
                                    <form method="POST" action="{{ url('/kategori') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kategori_nama" class="form-control @error('kategori_nama') is-invalid  @enderror" id="kategori" placeholder="Nama Kategori" value="{{ old('kategori_nama') }}">
                                            @error('kategori_nama')
