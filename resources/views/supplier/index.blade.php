                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-primary btn-round ml-auto" style="color: white" href="{{ '/supplier/create' }}">
                                    ...
                                    <table id="basic-datatables" class="display table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $data->supplier_kontak }}</td>
                                                <td>{{ $data->supplier_email }}</td>
                                                <td>{{ $data->supplier_alamat }}</td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="/supplier/{{ $data->supplier_id }}/edit" class="btn btn-link btn-primary" data-toggle="tooltip" data-original-title="Edit Data">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <form action="{{url('/supplier/'.$data->supplier_id) }}" method="POST" class="d-inline" style="margin-top: 0.5px ">
